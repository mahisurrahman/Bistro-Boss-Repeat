   ...
   return (
      ...
      <div className="w-10/12 mx-auto grid grid-cols-2 items-center justify-center gap-10">
        <div className="h-[500px]">
          <form className="border-4 px-10 py-5 rounded-2xl border-zinc-950 h-[500px]">
            ...
            <div className="mt-5 flex justify-between items-center">
              <h1 className="underline text-lg font-extrabold text-zinc-950 uppercase tracking-widest">Old to Bistro Boss?</h1>
              <Link to="/login"><button className="duration-700 text-xl px-6 py-1 font-extrabold bg-zinc-950 text-orange-500 border-2 border-zinc-950 rounded-lg uppercase hover:border-zinc-100 hover:bg-zinc-100 hover:cursor-pointer hover:duration-700">Login</button></Link>
            </div>
            <div className="mt-4 flex justify-center items-center">
            <button className="duration-700 text-xl px-6 py-1 font-extrabold bg-zinc-950 text-orange-500 border-2 border-zinc-950 rounded-lg uppercase hover:border-zinc-100 hover:bg-zinc-100 hover:cursor-pointer hover:duration-700">Sign Up With Google</button>
            </div>
          </form>
        </div>
